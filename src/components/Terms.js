      ...
      <div className="w-section">
        <div className="w-container">
          ...
          <p className="paragraph">
            ...
            <br />
            <br />‍<strong>Application</strong> means the software program
            provided by the Company downloaded by You on any electronic device,
            named NGL
            <br />
            <br />‍<strong>Application Store</strong> means the digital
            ...
            <br />
            <br />‍<strong>Account</strong> means a unique account created for
            You to access our Service or parts of our Service.
            <br />
            <br />‍<strong>Country</strong> refers to: California, United States
            <br />
            <br />‍<strong>Company</strong> (referred to as either "the
            Company", "We", "Us" or "Our" in this Agreement) refers to NGL Labs
            LLC, 253 N. La Peer Dr, Beverly Hills, CA 90211.
            <br />
            <br />‍<strong>Content</strong> refers to content such as text,
            ...
            <br />
            <br />‍<strong>In-app Purchase</strong> refers to the purchase of a
            ...
            <br />
            <br />‍<strong>Service</strong> refers to the Application.
            <br />
            ...
            or unauthorized use of Your account.You may not use as a username
            ...
            rights.Impersonating any person or entity including the Company and
            ...
            and complies with this Terms, refuse or remove this Content. <br />
            <br />
            ...
            to a usable state.You agree to maintain a complete and accurate copy
            of any Content in a location independent of the Service.Copyright
            Policy
            <br />
            <br />‍
            <strong>
            ...
            our copyright agent via email at hello@nglapp.com and include in
            ...
            <br />
            <br />A description of the copyrighted work that You claim has been
            ...
            <br />
            <br />
            You can contact our copyright agent via email at hello@nglapp.com.
